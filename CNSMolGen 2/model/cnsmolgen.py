...
from cnsmolgen_bidir_lstm import BiDirLSTM
...
class CNSMolGen():
    ...
    def _build_model(self):
        # Build a new model or load a model
    ...
    def build(self, name=None):
        ...
        #Load model state dictionary
            self._lstm.load_state_dict(torch.load(name + '.dat', map_location=self._device))
    ...
    def save(self, name='test_model'):
        ...
        torch.save(self._lstm.state_dict(), name + '.dat')
